...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $VERIFY_TOKEN = 'K2BlqR2D/rKyZZtVHben2K2BlqR2DDPid5Bua9IntX8aHtFD1BgCTrDQkune4/rUkOuw';
...
if($form_id && $leadgen_id && !empty($field_data)){
      ...
      //  $code_postal=$answers_data["Code_Postal"];
       ...
       $phone=$answers_data["phone"];
        ...
        $campaign            = '77c67186-cd55-4fa3-810d-df4261ca97b0'; //ENIGIE_LEADS
        $Flag='ENGIE_LEADS_VDATA_OUT';
        ...
        $request_array        = array(
              ...
              #	lead data
              'ACTIVITE'                => $Flag,
              'FOURNISSEUR_ACTUEL'=>$fai_actuel,
              #'Code_Postal___Adresse_Titulaire'                => $code_postal,
              'EMAIl_PRIO_1'                =>  $email_titulaire,
          ...
          $data_id=collect_data($connect, $form_id,'ENERGIE',$leadgen_id, $adset_name,$fai_actuel,$fai_actuel_val,$email_titulaire, $phone,json_encode($return),$httpcode);
